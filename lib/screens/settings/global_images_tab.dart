  ...
  Future<void> _loadGlobalImages() async {
    ...
    try {
      ...
      if (mounted) {
        final l10n = AppLocalizations.of(context)!;
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${l10n.failedToLoadGlobalImages}: $e')),
        );
      }
    } finally {
      if (mounted) {
  ...
  Future<void> _deleteGlobalImage(GlobalImageModel image) async {
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(l10n.globalImageDeletedSuccess),
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('${l10n.failedToDeleteGlobalImage}: $e'),
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: dialogL10n.imageNameHint2,
  ...
  void _showImagePreview(GlobalImageModel image) async {
    try {
      ...
      if (mounted) {
        final l10n = AppLocalizations.of(context)!;
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${l10n.failedToLoadImage}: $e')),
        );
      }
    }
  }
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            DateFormat('MMM dd, yyyy').format(image.uploadDate),
                            style: TextStyle(
                              color: Colors.grey[600],
                              fontSize: 12,
                            ),
