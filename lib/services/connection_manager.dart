...
class ConnectionManager {
  ...
  bool get lastSyncSuccess => _currentSettings?.lastSyncSuccess ?? true;
  ...
  Future<void> initializeConnection() async {
    ...
    try {
      ...
      if (settings != null && settings.hasCredentials) {
        ...
        // Broadcast initial sync status based on last sync result
        _syncStatusController.add(settings.lastSyncSuccess);
  ...
  Future<void> _testConnectionInBackground() async {
    ...
    try {
      ...
      if (_isConnected) {
        ...
        // Broadcast sync status based on last sync result
        _syncStatusController.add(_currentSettings?.lastSyncSuccess ?? true);
      } else {
