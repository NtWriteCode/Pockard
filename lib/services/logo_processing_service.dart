...
class LogoProcessingService {
  ...
  Future<String> _createPaddedCanvas({required ui.Image originalImage, required int targetSize, required Color backgroundColor, required Directory tempDir}) async {
    ...
    final ui.Canvas canvas = Canvas(recorder, Rect.fromLTWH(0, 0, targetSize.toDouble(), targetSize.toDouble()));
