...
class PreferencesSyncService {
  ...
  Future<void> uploadPreferences({required Map<String, dynamic> displaySettings, required List<String> tagOrder}) async {
    ...
    try {
      ...
      debugPrint('Preferences uploaded successfully');
    } catch (e) {
      debugPrint('Error uploading preferences: $e');
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>?> downloadPreferences() async {
    ...
    try {
      ...
      if (!exists) {
        debugPrint('Preferences file does not exist on server');
        return null;
      }
      ...
      debugPrint('Preferences downloaded successfully');
      return preferences;
    } catch (e) {
